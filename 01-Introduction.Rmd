...
<span style="color:blue">$X$ in function below is just a $1\times n$ column vector and $\hat Y$ is a single output</span>.  
$$
\begin{align}
...
\end{align}
$$
If $X$ and $Y$ are matrixes and use same symbols as previous chapter:   
$$
\begin{align}
